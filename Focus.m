...
gThreshold = str2double(get(hObject,'String'));
...
rThreshold = str2double(get(hObject,'String'));
...
refSide = contents{get(hObject,'Value')};
...
emissionRadius = str2double(get(hObject,'String'));
...
exclusionRadius = str2double(get(hObject,'String'));
